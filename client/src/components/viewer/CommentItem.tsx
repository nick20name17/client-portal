...
export function CommentItem({
  ...
  const anchorResolved = anchorResolvedMap?.[String(comment.id)];
  ...
  return (
    <div
      ...
      style={{
        ...
        borderLeftWidth: 3,
        borderLeftColor: comment.resolved ? "var(--status-done)" : "var(--primary)",
      }}
    ...
    >
      ...
      {showAttachedBadge ? (
        <div className="mt-2 inline-flex items-center gap-1 rounded-full border border-primary/20 bg-primary/5 px-2.5 py-1 text-[11px] font-medium text-primary">
